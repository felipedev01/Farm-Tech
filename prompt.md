vc deve construir uma aplicação em python para calcular area de plantio de duas culturas milho e cafe

o usuario deve poder escolher o tipo de forma geometrica sera usada

depois o algoritmo deve pedir as dimensoes de acordo com a forma escolhida, e tambem o espaçamento entre linhas que seria o corredor ja que estas culturas serão plantadas em ruas

e a aplicação deve retornar a area de plantio total a quantidade de ruas comprimento total das ruas em m, e a area equivalente a um metro do comprimento da rua


mas por enquanto o calculo de insumos e demias funcionalidades estão fora de escopo sera implementado no segundo passo



é importante que as formas geometricas ja estejam como opções de escolha para o usuario


abaixo tem os requisitos obrigatorios da atividade é preciso seguir a risca
